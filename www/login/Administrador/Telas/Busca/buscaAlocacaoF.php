...
WHERE
nomeFuncionario LIKE '%$busca%' AND tbnivelusuario.descricaoNivelUsuario like 'Fiscal'
OR numLinha LIKE '%$busca%' AND tbnivelusuario.descricaoNivelUsuario like 'Fiscal'
OR nomeLinha LIKE '%$busca%' AND tbnivelusuario.descricaoNivelUsuario like 'Fiscal'
OR inicioAlocacao LIKE '%$busca%' AND tbnivelusuario.descricaoNivelUsuario like 'Fiscal'
OR fimAlocacao LIKE '%$busca%' AND tbnivelusuario.descricaoNivelUsuario like 'Fiscal'
OR descricaoTurno LIKE '%$busca%' AND tbnivelusuario.descricaoNivelUsuario like 'Fiscal'
OR statusAlocacao LIKE '%$busca%' AND tbnivelusuario.descricaoNivelUsuario like 'Fiscal'
ORDER BY fimAlocacao ASC");
