...
session_start(); $nomeUsuario= $_SESSION['nomeUsuario'];
...
<body>
    ...
    <div id="main" class="container-fluid">
        ...
        <form action="../../Function/Cadastrar/cadastrarAlocacaoF.php" method="post" id="cadastrar">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <div class="input-group">
                    <input type="text" class="form-control" id="Fiscal" name="Fiscal" placeholder="Ex.: João" readonly>
                    <span class="input-group-btn">
            ...
            <div class="row">
                ...
                <?php
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input type="text" class="form-control" id="status" name="status" disabled value="Disponivel">
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
               ...
               /*$conn = mysqli_connect('fdb20.agilityhoster.com','2753888_bdfiscall','clover4folhas','2753888_bdfiscall');*/     $conn = mysqli_connect('localhost','root','','bdfiscall');
                ...
                ON tbusuario.codUsuario = tbfuncionario.codUsuario WHERE codNivelUsuario=3
    ...
    <script>
        $(document).ready(function() {
            $("form#cadastrar").submit(function() {
                ...
                $.post('../../Function/Cadastrar/cadastrarAlocacaoF.php', {
