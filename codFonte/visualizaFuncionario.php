...
$nomeUsuari = $nome[0]; ?>
                ...
                <div id="divEsconder">
                    <div class="form-group col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <input  class="form-control" placeholder="claudia.r@hotmail.com" id="inpEmail">
                        </div>
                    </div>
                    <!--   cargo -->
                 ...
                 <select id="inpCargo" name="codCargo" required class="form-control">
                                <option value="">
                                    Selecione...
                                </option>
                                <?php
                    ...
                    <!-- data fim cadastro -->
                    <div class="form-group col-md-2">
                        <label class="form-check-label" id="lblDataEscolha">
                            Data de Fim
                        </label>
                        <div class="input-group">
                            <span class="input-group-addon">
                                <input type="checkbox" aria-label="..." id="chkDataEscolha">
                           </span>
                            ...
                            while($element = mysqli_fetch_array($result)){
                                ...
                                if($loginUsuario!=$loginTeste){
                                    echo"<tr>
                                        ...
                                        <td data-title='rgFuncionario'id='limite'>$rgFuncionario</td>
                                        <td data-title='emailFuncionario' id='limite'>$emailFuncionario</td>
                                        <td data-title='cnhFuncionario'id='limite'>$cnhFuncionario</td>
                                    ...
                                    echo"<tr>
                                        ...
                                        <td data-title='emailFuncionario' id='limite'>$emailFuncionario</td>
                                        <td data-title='cnhFuncionario'id='limite'>$cnhFuncionario</td>
                                        <td data-title='cpfFuncionario'id='limite'>$cpfFuncionario</td>
                                        <td data-title='loginUsuario' id='limite'>$loginUsuario</td>
                                        <td data-title='descricaoNivelUsuario'id='limite'>$tipoUsuario</td>
    ...
    <script>
        function bFiltro() {
            ...
            var cDataEscolha = document.getElementById('chkDataEscolha').checked;
            ...
            } else if (cCargo == false && cEmail == false && cDataCadastro == true && cDataEscolha == true) {
                escolha = 13;
                $.post('../../Function/Filtro/ftFuncionario.php', {
                        escolha: escolha,
                        DataCadastro: DataCadastro,
