...
/*$connect = mysqli_connect('fdb20.agilityhoster.com','2753888_bdfiscall','clover4folhas','2753888_bdfiscall');*/     $connect = mysqli_connect('localhost','root','','bdfiscall');
    ...
    $query = "SELECT * FROM tblinha INNER JOIN tbponto ON tbponto.codLinha = tblinha.codLinha WHERE tblinha.codLinha = '$codLinha' AND  codTipoViagem='1'";
    $res = mysqli_query($connect, $query);
    $query2 = "SELECT * FROM tblinha INNER JOIN tbponto ON tbponto.codLinha = tblinha.codLinha WHERE tblinha.codLinha = '$codLinha' AND  codTipoViagem='2'";
