...
<html lang="pt-br">
    ...
    <body>
        ...
        <script src ="../../../bootstrap/js/cpfcnpj.js"></script>

        <div id="main" class="container-fluid">
            <h3 class="page-header">Editar Cooperativa</h3>
            ...
            <form id="editar" method="post">
                <div class="row">
                    <?php
                        ...
                        $codigo = filter_input(INPUT_GET, 'codCooperativa', FILTER_SANITIZE_NUMBER_INT);
                        $result_cooperativa = "SELECT * FROM tbcooperativa WHERE codCooperativa = '$codigo'";
                        $resultado_cooperativa = mysqli_query($connect, $result_cooperativa);
                        $row_cooperativa = mysqli_fetch_assoc($resultado_cooperativa);
                    ?>
                    <input type="hidden" id="codCooperativa" name="codCooperativa" value="<?php echo $codigo ?>">
                    <div class="form-group col-md-6">
                        <label for="campo1">Nome:</label>
                        <input type="text" class="form-control" id="nomeCooperativa" name="nomeCooperativa" placeholder="Unileste" value="<?php echo $row_cooperativa['nomeCooperativa']; ?>">
                    </div>
                </div>
                    <div class="row">
                    <div class="form-group col-md-6">
                        <label for="campo2">E-mail:</label>
                        <input type="text" class="form-control" id="emailCooperativa" name="emailCooperativa" placeholder="Unileste@unileste" value="<?php echo $row_cooperativa['emailCooperativa']; ?>">
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-6">
                        <label for="campo2">CNPJ:</label>
                        <input type="text" class="form-control" id="cnpjCooperativa" name="cnpjCooperativa" placeholder="00.000.000/0000-00" value="<?php echo $row_cooperativa['cnpjCooperativa']; ?>" onBlur="validaFormato(this);" onkeypress="return (apenasNumeros(event))">
                    </div>
                        <style>
                            #divResultado{
...
<script> 
    ...
    $("form#editar").submit(function() {
        ...
        $.post('../../Function/Editar/editarCooperativa.php', {
